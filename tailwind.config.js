...
export default {
    ...
    theme: {
        extend: {
            ...
            boxShadow: {
                'elev-1': '0 12px 24px -18px rgba(15, 23, 42, 0.35), 0 2px 6px -3px rgba(15, 23, 42, 0.2)',
                'elev-2': '0 20px 40px -24px rgba(15, 23, 42, 0.45), 0 6px 12px -6px rgba(15, 23, 42, 0.25)',
            },
            borderRadius: {
                xl: '1rem',
                '2xl': '1.25rem',
