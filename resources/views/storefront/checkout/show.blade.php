<x-storefront-layout>
    <div class="max-w-3xl mx-auto px-6 py-10">
        <div class="flex flex-wrap items-center justify-between gap-4 mb-8">
            ...
            <a class="rounded-full border border-sand-200 px-3 py-1.5 text-sm font-medium text-ink-700 transition hover:border-sand-300 hover:text-ink-900" href="{{ route('storefront.cart.index') }}">Back to cart</a>
        </div>
        ...
        <x-ui.card title="Delivery details" description="Everything we need to finalize the order.">
